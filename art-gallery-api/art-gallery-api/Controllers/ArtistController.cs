...
namespace art_gallery_api.Controllers
{
    ...
    public class ArtistController : ControllerBase
    {
        ...
        /// <summary>
        /// Gets the number of artists from the specified state.
        /// </summary>
        /// <returns> The number of artists from the specified state. </returns>
        /// <response code="200"> Returns the number of artists from the specified state, or 0
